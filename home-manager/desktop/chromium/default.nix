{config, ...}: {
  ...
  home.file.".config/BraveSoftware/Brave-Browser/Default/Bookmarks".source = config.lib.file.mkOutOfStoreSymlink "${config.var.configDirectory}/home-manager/desktop/chromium/Bookmarks";
