  ...
  home.file.".config/rofi/config2.rasi" = {
    ...
    text = ''
      ...
      * {
          ...
          background-alt: ${clrs.background-alt}ff;
          foreground:     ${clrs.foreground}ff;
          selected:       ${clrs.accent}ff;
          active:         ${clrs.accent}ff;
          urgent:         #${stylix.base08}ff;
          border-colour:  ${clrs.border-color}ff;
      ...
      window {
          ...
          /* Backgroud Image */
          //background-image:          url("~/.current_wallpaper", none);
